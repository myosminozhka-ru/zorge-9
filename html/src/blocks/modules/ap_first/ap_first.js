    ...
    if ($('[name="SIMPLE_FORM_7"]').length) {
        $('[name="SIMPLE_FORM_7"]').submit(function(event) {
            ...
            form_submit('[name="SIMPLE_FORM_7"]', function (result) {
                ...
                $('[name="SIMPLE_FORM_7"]').find('.form-wrapper__btns').fadeOut();
                $('[name="SIMPLE_FORM_7"]').closest('.form-wrapper-inner').find('.form-wrapper__subtitle').fadeOut();
                $('[name="SIMPLE_FORM_7"]').closest('.form-wrapper-inner').find('.form-wrapper__title').html(result.SUCCESS);
                }
            });
        });
    }
